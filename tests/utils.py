...
def mock_request_get(url, timeout):
    ...
    if path == "/chains/main/blocks/191232/context/contracts/tz1T5woJN3r7SV5v2HGDyA5kurhbD9Y8ZKHZ/balance" \
    ...
    if path == "/chains/main/blocks/191232/context/contracts/tz1V9SpwXaGFiYdDfGJtWjA61EumAH3DwSyT/balance" \
    ...
    if path == "/chains/main/blocks/191232/context/contracts/tz1fgX6oRWQb4HYHUT6eRjW8diNFrqjEfgq7/balance" \
    ...
    if path == "/chains/main/blocks/191232/context/contracts/tz1YTMY7Zewx6AMM2h9eCwc8TyXJ5wgn9ace/balance" \
    ...
    if path == "/chains/main/blocks/191232/context/contracts/tz1L1XQWKxG38wk1Ain1foGaEZj8zeposcbk/balance" \
    ...
    if path == "/chains/main/blocks/191232/context/contracts/tz1gtHbmBF3TSebsgJfJPvUB2e9x8EDeNm6V/balance" \
    ...
    if path == "/chains/main/blocks/191232/context/contracts/tz1RRzfechTs3gWdM58y6xLeByta3JWaPqwP/balance" \
    ...
    if path == "/chains/main/blocks/225280/metadata":
        return MagicMock(status_code=HTTPStatus.OK, json=lambda: {
            "balance_updates": [
                {"kind": "freezer", "category": "deposits", "delegate": "tz1gtHbmBF3TSebsgJfJPvUB2e9x8EDeNm6V", "cycle": 51, "change": "-14272000000"},
                {"kind": "freezer", "category": "fees", "delegate": "tz1gtHbmBF3TSebsgJfJPvUB2e9x8EDeNm6V", "cycle": 51, "change": "-8374"},
                {"kind": "freezer", "category": "rewards", "delegate": "tz1gtHbmBF3TSebsgJfJPvUB2e9x8EDeNm6V", "cycle": 51, "change": "-354166658"},
