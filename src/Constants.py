...
CURRENT_TESTNET = 'HANGZHOU2NET'

FIRST_GRANADA_LEVEL = 1916929

# Providers api prefix
# Public RPC
PUBLIC_NODE_URL = {
    'MAINNET': 'https://mainnet-tezos.giganode.io',
    CURRENT_TESTNET: 'https://hangzhou.smartpy.io'
}
...
DEFAULT_NETWORK_CONFIG_MAP = {
    ...
    CURRENT_TESTNET: {'NAME': CURRENT_TESTNET, 'NB_FREEZE_CYCLE': 3, 'BLOCK_TIME_IN_SEC': 15, 'MINIMAL_BLOCK_DELAY': 15, 'BLOCKS_PER_CYCLE': 4096,
                      'BLOCKS_PER_ROLL_SNAPSHOT': 256, 'BLOCK_REWARD': 78125, 'ENDORSEMENT_REWARD': 78125},
}
