...
class TestVerboseLoggingHelper(TestCase):
    ...
    def test_reset(self):
        ...
        self.assertEqual(len(self.get_archive_files(self.backup_dir)), self.keep_at_most)

    def test_is_archive_file(self):
        self.assertTrue(self.verbose_logging_helper.is_archive_file('app_verbose_init_20200101000000.zip'))
        self.assertTrue(self.verbose_logging_helper.is_archive_file('app_verbose_10_20200101000000.zip'))
        self.assertFalse(self.verbose_logging_helper.is_archive_file('app_verbose_init_20200101000000.log'))
        self.assertFalse(self.verbose_logging_helper.is_archive_file('app_log_init_20200101000000.zip'))

    def test_is_log_file(self):
        self.assertTrue(self.verbose_logging_helper.is_log_file('app_verbose_init_20200101000000.log'))
        self.assertTrue(self.verbose_logging_helper.is_log_file('app_verbose_10_20200101000000.log'))
        self.assertFalse(self.verbose_logging_helper.is_log_file('app_verbose_init_20200101000000.zip'))
        self.assertFalse(self.verbose_logging_helper.is_log_file('app_log_init_20200101000000.log'))

    def test_get_log_file_path(self):
        cycle = 12
        cycle12_log_file_path = self.verbose_logging_helper.get_log_file_path(cycle)
        self.assertTrue(self.verbose_logging_helper.is_log_file(os.path.basename(cycle12_log_file_path)))
    ...
    def test_archive(self):
        ...
        archive_file_base_names = [os.path.splitext(os.path.basename(f))[0] for f in
                                   self.get_archive_files(self.backup_dir)]

        self.assertTrue(os.path.splitext(os.path.basename(log_file_path_before))[0] in archive_file_base_names)
