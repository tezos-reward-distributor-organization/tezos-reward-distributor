...
class RpcBlockApiImpl(BlockApi):
    ...
    def __init__(self, nw, wllt_clnt_mngr, node_url, protocol='http'):
        ...
        self.COMM_REVELATION = " rpc get %BASE_URL%/chains/main/blocks/head/context/contracts/{}/manager_key".replace('%BASE_URL%',BASE_URL)
    ...
    def get_revelation(self, pkh, verbose=False):
        _, response = self.wllt_clnt_mngr.send_request(self.COMM_REVELATION.format(pkh))
