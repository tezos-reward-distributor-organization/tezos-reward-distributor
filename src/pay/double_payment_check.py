...
from util.dir_utils import payment_dir_c, get_payment_report_file_path, get_busy_file
...
def check_past_payment(payments_root, payment_cycle):
    ...
    payment_file = get_payment_report_file_path(payments_root, payment_cycle, 0)
    ...
    payment_file_failed = get_payment_report_file_path(payments_root, payment_cycle, 1)
