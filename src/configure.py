...
messages = {
    ...
    'rewardstype': "Specify if baker pays 'ideal', 'expected' or 'actual' rewards (Be sure to read the documentation to understand the difference). Type enter for 'actual'",
...
def onrewardstype(input):
    ...
    try:
        ...
        printe("Invalid option for rewards type. Please enter 'actual', 'expected' or 'ideal'.")
        return
