...
content0 = '{ "kind": "transaction", "amount": "100000", "source": "tz1YZReTLamLhyPLGSALa4TbMhjjgnSi2cqP", "destination": "tz1MWTkFRXA2dwez4RHJWnDWziLpaN6iDTZ9", "storage_limit": "0", "gas_limit": "200", "fee": "0", "counter": "%COUNTER%" }'
content1='    "contents": [' \
      '{' \
        '"kind": "transaction",'\
        '"amount": "10000",'\
        '"source": "tz1YZReTLamLhyPLGSALa4TbMhjjgnSi2cqP",'\
        '"destination": "tz1MWTkFRXA2dwez4RHJWnDWziLpaN6iDTZ9",'\
        '"storage_limit": "0",'\
        '"gas_limit": "200",'\
        '"fee": "0",'\
        '"counter": "%COUNTER%"'\
...
COMM_FORGE = CLIENT_PATH + " rpc post http://" + NODE_URL + "/chains/main/blocks/head/helpers/forge/operations with " + '\'{"contents": [ ' + content0 + ' ], "branch": "%BRANCH%"}\''
